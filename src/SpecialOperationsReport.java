...
public class SpecialOperationsReport extends JPanel{
	...
	JTextArea Selected_File=new JTextArea();	// It contains the options selected 
	...
	String folderForPdf="Special_Operations_Report";

SpecialOperationsReport(){
...
Sub.add("AS1");Sub.add("C02");Sub.add("C2A");Sub.add("C2B");Sub.add("C2C");Sub.add("C2D");Sub.add("C2E");Sub.add("CA1");Sub.add("EM1");Sub.add("HY1");Sub.add("IMS-01");Sub.add("IP6");Sub.add("M01");Sub.add("MOM");Sub.add("MT1");Sub.add("OS2");Sub.add("R2B");Sub.add("RI1");Sub.add("RS2");Sub.add("RS2A");Sub.add("SC1");Sub.add("SL1");Sub.add("YS1");
...
Upload.addActionListener(new ActionListener(){
	...
	try{
		...
		String adddd=SUB_NAME_Name+"_Reports"+"/"+folderForPdf+"/";
		...
		if(client.isConnected()){
			...
			try{
				fileNames=client.listNames("/oprnrpt/AnomalyDatabase/"+SUB_NAME_Name+"_Reports/Special_Operations_Report/");
		...
		String F_add;
		//System.out.println(Selected_File.getText());
		...
		if(Selected_File.getText().equals("AS1")||Selected_File.getText().equals("C2C")||Selected_File.getText().equals("C2D")||Selected_File.getText().equals("C2E")||Selected_File.getText().equals("EM1")||Selected_File.getText().equals("HY1")||Selected_File.getText().equals("M01")||Selected_File.getText().equals("MOM")||Selected_File.getText().equals("MT1")||Selected_File.getText().equals("R2B")||Selected_File.getText().equals("RI1")||Selected_File.getText().equals("RS2")||Selected_File.getText().equals("RS2A")||Selected_File.getText().equals("SC1")||Selected_File.getText().equals("SL1"))
		{
			if(Selected_File.getText().equals("AS1"))
			{
				linkadd="<p class=MsoListParagraphCxSpMiddle style='text-indent:-18.0pt;line-height:150%;mso-list:l0 level1 lfo2'><![if !supportLists]><span style='font-size:13.0pt;line-height:150%;font-family:Symbol;mso-fareast-font-family:Symbol;mso-bidi-font-family:Symbol;color:#002060'><span style='mso-list:Ignore'>·<span style='font:7.0pt \"Times New Roman\"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span><![endif]><b style='mso-bidi-font-weight:normal'><span style='font-size:13.0pt;line-height:150%;font-family:\"Arial\",\"sans-serif\";mso-fareast-font-family:\"Times New Roman\";color:#002060'><a href=\"Special_Operations_Report/";
				...
				htmlloc.setText("/oprnrpt/AnomalyDatabase/"+SUB_NAME_Name+"_Reports"+"/"+SUB_NAME_Name+"_sop.htm");
				comment_put.setText("<!--ayushTheGtearDevelopEROfUNIVerse-->");
			}
			if(Selected_File.getText().equals("C2C"))
			{
				linkadd="<p class=MsoListParagraph style='text-indent:-18.0pt;line-height:115%;mso-list:l0 level1 lfo2'><![if !supportLists]><span style='font-family:Symbol; mso-fareast-font-family:Symbol;mso-bidi-font-family:Symbol'><span style='mso-list:Ignore'>·<span style='font:7.0pt \"Times New Roman\"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span><![endif]><span style='mso-fareast-font-family:\"Times New Roman\"'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
			...
			if(Selected_File.getText().equals("C2E"))
			{
				linkadd="<p class=MsoListParagraphCxSpFirst style='text-indent:-18.0pt;mso-list:l0 level1 lfo2'><![if !supportLists]><span style='font-family:Symbol;mso-fareast-font-family:Symbol;mso-bidi-font-family: Symbol;color:blue'><span style='mso-list:Ignore'>·<span style='font:7.0pt \"Times New Roman\"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span><![endif]><span style='color:blue'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
				end="</a><o:p></o:p></span></p>"; 
			...
			if(Selected_File.getText().equals("M01"))
			{
				...
				linkadd= "<p class=MsoListParagraphCxSpFirst style='text-indent:-18.0pt;mso-list:l0 level1 lfo2'><![if !supportLists]><span style='font-size:14.0pt;mso-bidi-font-size:12.0pt;font-family:Symbol; mso-fareast-font-family:Symbol;mso-bidi-font-family:Symbol;color:#0066CC'><span style='mso-list:Ignore'>·<span style='font:7.0pt \"Times New Roman\"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><![endif]><b style='mso-bidi-font-weight:normal'><u><span style='font-size:14.0pt;mso-bidi-font-size:12.0pt;font-family:\"Arial\",\"sans-serif\";color:#0066CC'><o:p><span style='text-decoration:none'>&nbsp;</span><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
				...
				F_add=linkadd+linkadd1+aa+FName+end;
				WhatTo_add.setText(F_add);
				htmlloc.setText("/oprnrpt/AnomalyDatabase/M01_Reports/M01_sop.htm");
				comment_put.setText("<!--ayushTheGtearDevelopEROfUNIVerse-->");

			}if(Selected_File.getText().equals("MOM"))
			{
				linkadd="<p class=MsoListParagraphCxSpMiddle style='text-indent:-18.0pt;mso-list:l0 level1 lfo2; mso-yfti-cnfc:68'><![if !supportLists]><span class=MsoHyperlink><span style='font-size:14.0pt;font-family:Symbol;mso-fareast-font-family:Symbol;  mso-bidi-font-family:Symbol;text-decoration:none;text-underline:none'><span style='mso-list:Ignore'>·<span style='font:7.0pt \"Times New Roman\"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </span></span></span></span><![endif]><span class=MsoHyperlink><span style='font-size:14.0pt;font-family:\"Arial\",\"sans-serif\"'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
			...
			}if(Selected_File.getText().equals("R2B"))
			{
				...
				linkadd="<p class=MsoNormal align=center style='text-align:left'><b  style='mso-bidi-font-weight:normal'><span style='font-size:14.0pt;mso-bidi-font-size: 12.0pt;font-family:\"Arial\",\"sans-serif\";color:red'></span></b><b style='mso-bidi-font-weight:normal'><span style='font-size:14.0pt;mso-bidi-font-size:12.0pt;font-family:\"Arial\",\"sans-serif\";color:#0070C0'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
				end="</a><o:p></o:p></span></b></p>"; 
			...
			{
				System.out.println("yes iNside if of RTI");
				// RI1_sop
				...
				F_add=linkadd+linkadd1+aa+FName+end;
				WhatTo_add.setText(F_add);
				htmlloc.setText("/oprnrpt/AnomalyDatabase/RI1_Reports/RI1_sop.htm");
				comment_put.setText("<!--ayushTheGtearDevelopEROfUNIVerse-->");
			...
			if(Selected_File.getText().equals("SL1"))
			{	
				linkadd="<p class=MsoListParagraphCxSpFirst style='text-indent:-.25in;line-height: 115%;mso-list:l0 level1 lfo2'><![if !supportLists]><span style='font-family:Symbol;mso-fareast-font-family:Symbol;mso-bidi-font-family:Symbol;color:#0066CC'><span style='mso-list:Ignore'>·<span style='font:7.0pt \"Times New Roman\"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><![endif]><u><span style='font-family:\"Arial\",\"sans-serif\"; color:#0066CC'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
				end="</a><o:p></o:p></span></u></p>"; 
				F_add=linkadd+linkadd1+aa+FName+end;
				WhatTo_add.setText(F_add);
				htmlloc.setText("/oprnrpt/AnomalyDatabase/"+SUB_NAME_Name+"_Reports"+"/"+SUB_NAME_Name+"_sop.htm");
				comment_put.setText("<!--ayushTheGtearDevelopEROfUNIVerse-->");
		...
		else
		{
			if(Selected_File.getText().equals("C02")){
				...
				htmlloc.setText("/oprnrpt/AnomalyDatabase/"+SUB_NAME_Name+"_Reports"+"/"+add_loc_name+"_sop.htm");
				comment_put.setText("<!--ayushTheGtearDevelopEROfUNIVerse-->");
				linkadd="<p class=MsoListParagraphCxSpMiddle style='text-indent:-.25in;line-height:150%;mso-list:l0 level1 lfo2;mso-yfti-cnfc:68'><![if !supportLists]><span style='font-family:Symbol;mso-fareast-font-family:Symbol;mso-bidi-font-family:Symbol;color:#0066CC'><span style='mso-list:Ignore'>·<span style='font:7.0pt \"Times New Roman\"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span><![endif]><u><span style='color:#0066CC'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
				end="</a><o:p></o:p></span></u></p>"; 
			...
			if(Selected_File.getText().equals("C2A")){
				System.out.println("Yes In c2a");
				htmlloc_INSUB.setText("c2a");
				String add_loc_name=htmlloc_INSUB.getText();
				htmlloc.setText("/oprnrpt/AnomalyDatabase/"+SUB_NAME_Name+"_Reports"+"/"+add_loc_name+"_sop.html");
				comment_put.setText("<!--ayushTheGtearDevelopEROfUNIVerse-->");
				linkadd="<p class=MsoListParagraphCxSpFirst style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:54.0pt;mso-add-space:auto;text-indent:-18.0pt;line-height:125%;mso-list:l0 level1 lfo2'><![if !supportLists]><span style='font-size:14.0pt;line-height:125%;font-family:Symbol;mso-fareast-font-family:Symbol;mso-bidi-font-family:Symbol;color:#0070C0;mso-bidi-font-weight:bold'><span style='mso-list:Ignore'>·<span style='font:7.0pt \"Times New Roman\"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span><![endif]><b><u><span style='font-family:\"Arial\",\"sans-serif\";color:#0066CC'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
				end="</a><o:p></o:p></span></u></b></p>"; 
			...
			if(Selected_File.getText().equals("C2B")){
				...
				htmlloc.setText("/oprnrpt/AnomalyDatabase/"+SUB_NAME_Name+"_Reports"+"/"+add_loc_name+"_sop.htm");
				comment_put.setText("<!--ayushTheGtearDevelopEROfUNIVerse-->");
				linkadd="<li class=MsoNormal style='color:#0070C0;margin-top:12.0pt;margin-bottom:12.0pt;mso-list:l1 level1 lfo3;tab-stops:list .5in'><b><span style='font-size:14.0pt;font-family:\"Arial\",\"sans-serif\";mso-fareast-font-family:\"Times New Roman\"'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
				end="</a><o:p></o:p></span></b></li>"; 
				F_add=linkadd+linkadd1+aa+FName+end;
				WhatTo_add.setText(F_add);
			...
			if(Selected_File.getText().equals("IP6")){
				htmlloc_INSUB.setText("ip6");
				String add_loc_name=htmlloc_INSUB.getText();
				htmlloc.setText("/oprnrpt/AnomalyDatabase/"+SUB_NAME_Name+"_Reports"+"/"+add_loc_name+"_sop.htm");
				comment_put.setText("<!--ayushTheGtearDevelopEROfUNIVerse-->");
				linkadd="<li class=MsoNormal style='color:#0070C0;margin-top:12.0pt;margin-bottom: 12.0pt;mso-list:l1 level1 lfo3;tab-stops:list 36.0pt'><b><span style='font-size:14.0pt;font-family:\"Arial\",\"sans-serif\";mso-fareast-font-family:\"Times New Roman\"'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
				end="</a><o:p></o:p></span></b></li>"; 
			...
			if(Selected_File.getText().equals("OS2")){
				htmlloc_INSUB.setText("os2");
				String add_loc_name=htmlloc_INSUB.getText();
				htmlloc.setText("/oprnrpt/AnomalyDatabase/"+SUB_NAME_Name+"_Reports"+"/"+add_loc_name+"_sop.htm");
				comment_put.setText("<!--ayushTheGtearDevelopEROfUNIVerse-->");
				linkadd="<p class=MsoListParagraphCxSpMiddle style='margin-left:.75in;mso-add-space:  auto;text-indent:-.25in;line-height:125%;mso-list:l0 level1 lfo2'><![if !supportLists]><span  class=MsoHyperlink><span style='font-family:Symbol;mso-fareast-font-family:  Symbol;mso-bidi-font-family:Symbol;text-decoration:none;text-underline:none'><span style='mso-list:Ignore'>·<span style='font:7.0pt \"Times New Roman\"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span></span><![endif]><span class=MsoHyperlink><spanstyle='font-family:\"Arial\",\"sans-serif\"'><a href=\"Special_Operations_Report/";
				linkadd1= File_Name.getText();
				aa="\">";
				FName=File_Name_Without_Extension.getText();
				end="</a><o:p></o:p></span></span></p>"; 
		...
		//System.out.println(htmlloc.getText());
		//System.out.println(comment_put.getText());
		...
		try{
			 ...
			 */
			File downloadFile1 = new File("backup\\"+SUB_NAME_Name+".htm");
			 ...
			 */
			File file = new File ("backup\\"+SUB_NAME_Name+"sop.htm"); // put download address of file
			...
			//System.out.println("FTP CLIENT CODE COME IN 2");
			client.setFileType(FTP.BINARY_FILE_TYPE);}
			File loc1=new File("backup\\"+SUB_NAME_Name+"sop.htm"); // location of file downloade
